...
def create_summary_slide(prs, title="summary", assignee="Assignee/Contributors: ?", deadline="Deadline: ?",
    ...
    add_textbox_with_label(slide, "Assignee/Contributors: ", assignee, 0.5, 0.9)
    add_textbox_with_label(slide, "Stakeholder: ", stakeholder, 7.5, 0.9)
    add_textbox_with_label(slide, "KRs: ", krs, 7.5, 1.4)
    add_textbox_with_label(slide, "Deadline: ", deadline, 0.5, 1.4)

    add_accomplishments_and_challenges(slide, accomplishments, challenges)

    add_status_info(slide, start, status, estimate, scope_changed)
